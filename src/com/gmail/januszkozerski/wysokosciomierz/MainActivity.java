...
//	private Sensor sensor = sensorManager.getDefaultSensor(Sensor.TYPE_PRESSURE);
	...
	private static final int max_values = 15; // How many values to measure to get average pressure (start point)
